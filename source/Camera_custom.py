...
class Camera:
    def __init__(self):
        ...
        self.n_air = 1.0  # Default refractive index of air
        self.n_acrylic = 1.49  # Default refractive index of acrylic
        self.n_water = 1.33  # Default refractive index of water
    ...
    def set_refractive_indices(self, n_air, n_acrylic, n_water):
        """
        Set the refractive indices for air, acrylic, and water.
        """
        self.n_air = n_air
